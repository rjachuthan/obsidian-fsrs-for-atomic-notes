...
If you see in your PR GitHub's warning `This branch has conflicts that must be resolved`, just ignore it. Don't merge or rebase your PR. Once your plugin passes all reviews, the Obsidian team will resolve those conflicts before publishing your plugin.
